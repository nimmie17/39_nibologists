...
<html>
    ...
    <div id="About" class="tabcontent">
      ...
      <a href="xxx.html"> <button type="button" class="btn btn-warning btn-lg btn-block"> Take them to an Ice Cream walk </button> <br> <br> </a>
      <a href="xxx1.html"><button type="button" class="btn btn-danger btn-lg btn-block">Hang out for a day</button> <br> <br> </a>
